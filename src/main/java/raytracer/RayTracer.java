...
public class RayTracer {
    ...
    public RayTracer(int width, int height) {
        ...
        materialsBuffer = new MaterialsBuffer(new Vector3f[]{new Vector3f(1, 1, 1), new Vector3f(0.5f, 0.5f, 0.5f)}, new Vector3f[]{new Vector3f(0, 0, 0), new Vector3f(1, 1, 1)}, new float[]{0, 0.9f});
    }
